...
class TestLooksLikeSecret:
    def test_detects_anthropic_key(self):
        from mcpsafetywarden.security_utils import looks_like_secret
...
class TestCredentialRefDB:
    def test_roundtrip(self):
        from mcpsafetywarden.database import create_credential_ref, resolve_credential_ref, delete_credential_refs
    ...
    def test_resolve_unknown_ref_returns_none(self):
        from mcpsafetywarden.database import resolve_credential_ref
    ...
    def test_delete_noop_on_empty_list(self):
        from mcpsafetywarden.database import delete_credential_refs
        delete_credential_refs([])   # must not raise

    def test_each_ref_is_unique(self):
        from mcpsafetywarden.database import create_credential_ref, delete_credential_refs
...
class TestInspectFailureCleanup:
    async def test_cref_deleted_when_inspection_fails(self):
        ...
        from mcpsafetywarden.database import get_server
